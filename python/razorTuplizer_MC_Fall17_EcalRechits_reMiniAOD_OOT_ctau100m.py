...
# This script processes the private GMSB sample with ctau = 10000cm, where the genParticles t0 is not available.
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
     ...
     '/store/group/phys_susy/razor/zhicaiz/GMSB_2016_Production/GMSB_L100TeV_Ctau10000cm_13TeV-pythia8/crab_CMSSW_9_3_6_GMSB_L100TeV_Ctau10000cm_MINIAODSIM_CaltechT2_22Apr2019/190423_165029/0000/AOD_1.root'
    )
)
...
process.ntuples = cms.EDAnalyzer('RazorTuplizer', 
    ...
    genParticles_t0 = cms.double(0.0), 
