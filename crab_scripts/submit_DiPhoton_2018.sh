...
for HT in \
    ...
    80toInf
do
                query_="dasgoclient --query=\"dataset=/DiPhotonJetsBox_M*${HT}*/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM instance=prod/global\""
                ...
                then
                    ...
                    echo "config.General.requestName = 'prod_Run2DelayedPhotonNtupler2018_DiPhotonJetsBox_M${HT}_Sherpa'" >> ${subfile} 
