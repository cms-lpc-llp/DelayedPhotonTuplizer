...
do
        ...
        do
                ...
                query_="dasgoclient --query=\"dataset=/${PS}/Run2018${era}-12Nov2019_UL2018-v6/MINIAOD instance=prod/global\""
                ...
                echo "config.General.requestName = 'prod_Run2DelayedPhotonNtupler_DataUL2018_${PS}_Run2018${era}'" >> ${subfile} 
                ...
                echo "config.JobType.psetName = '${CMSSW_BASE}/src/Tuplizer/DelayedPhotonTuplizer/python/razorTuplizer_DataUL_2018D_EcalRechits_OOTpho.py'" >> ${subfile} 
...
#                echo "config.Data.unitsPerJob = 100" >> ${subfile}
                #echo "config.Data.splitting = 'Automatic'" >> ${subfile} 
                echo "config.Data.lumiMask = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions18/13TeV/Legacy_2018/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'" >> ${subfile} 
                echo "" >> ${subfile} 
