...
do
             ...
             echo "config.General.requestName = 'Run2DelayedPhotonNtupler_MC2018_${PS}_100PerJob'" >> ${subfile} 
             ...
             echo "config.Data.outLFNDirBase = '/store/group/phys_susy/razor/run2/Run2DelayedPhotonNtuple/MC2018/backup/'" >> ${subfile} 
